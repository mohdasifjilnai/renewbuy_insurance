...
export class MotorinsuranceLandingPageComponent {
  ...
  insuranceCardData = {
    heading:`Types of Motor Insurance Policy`,
    subHeading: `You can choose from different types of motor insurance matching your needs - from basic third-party cover to comprehensive plans. Understand the options to choose the best fit for your vehicle.`,
    cards :[
      {
        imageUrl:
